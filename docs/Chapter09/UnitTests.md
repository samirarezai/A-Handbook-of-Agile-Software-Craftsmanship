...
- [Chapter 9 index](README.md)

<p align="center">
  <img src="../../assets/images/Chapter09/ch9.jpg" alt="Clean Code - Unit Tests" />
</p>
...
> Reference: *Professionalism and Test-Driven Development*, Robert C. Martin, Object Mentor, IEEE Software, May/June 2007 (Vol. 24, No. 3) pp. 32–36: [DOI](http://doi.ieeecomputersociety.org/10.1109/MS.2007.85)
...
> BUILD-OPERATE-CHECK: [FitNesse Acceptance Test Patterns](http://fitnesse.org/FitNesse.AcceptanceTestPatterns)
...
> Single-assert discussion: [Dave Astel’s blog entry](http://www.artima.com/weblogs/viewpost.jsp?thread=35578)
...
Stated like this, you can see that there is a general rule hiding amidst the miscellaneous tests. When you increment the month, the date can be no greater than the last day of the month. That implies that incrementing the month on February 28th should yield March 28th. That test is missing and would be a useful test to write.
...
Clean tests follow five other rules that form the acronym **F.I.R.S.T.** (Object Mentor Training Materials):
